import { ValueOf, NthDepthProperty } from "../types/utils";

export type UserKeys = typeof defaultUserKeys;
export type UserKeyMenu = keyof UserKeys;
export type UserKeyEvents = ValueOf<UserKeys>;
export type UserKeyEventsKey = NthDepthProperty<UserKeys, 2>;
export type UserKeyEventsValues = ValueOf<UserKeyEvents>;

export const defaultUserKeys = {
  "Main Gameplay": {
    comment: [
